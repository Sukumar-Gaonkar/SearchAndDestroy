...
class DummyPlayer:
    ...
    def __init__(self, game_map, moving_target, case, rule, iteration):
        self.map = game_map
        ...
        for dimen in range(5, 11):
            ...
            for case in range(1, 3):
                for rule in range(1, 3):
                    ...
                    dummy_player = DummyPlayer(game_master.game_map, moving_target, case, rule, iterations)
